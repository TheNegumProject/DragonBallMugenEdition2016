...
type = changestate
value = 3400
triggerall = !AIlevel&&command = "genkidama"&&roundstate = 2 && statetype != A && power >= 1000&&Life>=334
trigger1 = ctrl
...
type = changestate
value = 3300;3151
triggerall = !AIlevel&&command = "kaioken"&&roundstate = 2 && statetype = A && power >= 1000
trigger1 = ctrl
...
type = changestate
value = 3200
triggerall = !AIlevel&&command = "chokamehameha"&&roundstate = 2 && statetype != A && power >= 3000
triggerall = life>344
trigger1 = ctrl
trigger2 = (stateno = [200,419])&& movecontact
trigger3 = (stateno = [430,450])&& movecontact
;---------------------------------------------------------------------------
[State -1, KAIOKEN KAMEHAMEHA]
type = changestate
value = 3100
...
value=1020
triggerall=!AILevel && RoundState=2 && StateType != A 
triggerall = !AIlevel&&command = "kipush" 
...
type =ChangeState
value =3300;3010;3150
triggerall=AILevel&&Roundstate=2&&Statetype!=A&&Power>=1000&&random < (350 * (AIlevel ** 2 / 64.0))
...
triggerall=(p2bodydist x=[80,255])&&(p2bodydist y=[-80,5])
trigger1=ctrl
...
type = changestate
value = 4000
triggerall=AIlevel&&roundstate = 2 && statetype != A &&power >= 3000&&Life<=333
triggerall=(enemynear,Movetype!=A)&&(enemynear,statetype!=A)&&(enemynear,statetype!=L)
triggerall=(p2dist x=[50,180])&&(p2dist y=[-80,5])&&random<500*(AIlevel ** 2 / 64.0)
trigger1 = ctrl
trigger2 = (stateno = [200,450])&&anim!=221&&stateno!=420&&movecontact