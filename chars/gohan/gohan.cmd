...
type = changestate
value = 4100
triggerall = !AIlevel&&command = "superkamehameha"&&roundstate = 2 && statetype != A && power >= 3000
trigger1 = ctrl
...
type = changestate
value = 3100
triggerall = !AIlevel&&command = "rushkamehameha"&&roundstate = 2 && statetype != A && power >= 2000
trigger1 = ctrl
trigger2 = (stateno = [200,419])&& movecontact
trigger3 = (stateno = [430,449])&& movecontact
;---------------------------------------------------------------------------
...
type = changestate
value = 3020
triggerall = !AIlevel&&command = "masenko"&&roundstate = 2 && statetype = A && power >= 1000
trigger1 = ctrl
...
triggerall = !numhelper(1005) && !numhelper(1025) && !numhelper(1055)
trigger1 = ctrl
trigger2 = (stateno = [600,620])&& movecontact
trigger3 = (stateno = [630,650])&& movecontact
;-----------------------------------------------------------------------------------------
[State -1, Ki Blast]
type=ChangeState
value=1010;ifelse(command="Kohou_x",1100,ifelse(command="Kohou_y",1110,1120))
triggerall=!AILevel && RoundState=2 && StateType != A 
...
[State -1, Ki Blast]
type=ChangeState
value=1000;ifelse(command="Kohou_x",1100,ifelse(command="Kohou_y",1110,1120))
triggerall=!AILevel && RoundState=2 && StateType != A 
triggerall = command="Kiblast"
triggerall = !numhelper(1005) && !numhelper(1025) && !numhelper(1055)
trigger1 = ctrl
...
type = ChangeState
value = 123
triggerall = stateno != 100 && pos y = 0&&random < (100 * (AIlevel ** 2 / 64.0))
triggerall = AIlevel && numenemy&& statetype != A && roundstate = 2 && ctrl&&(p2bodydist y = [-300,-70])
trigger1 = enemy,vel y < -1&&(p2bodydist x = [ 0, 50])&&p2movetype != A
...
[State -1, ki blast]
type = changestate
value = 1000;ifelse(random < 500, 1010, 1000)
triggerall=AIlevel&&roundstate = 2 && statetype != A
...
triggerall=(p2dist x>=80)&&(p2dist y=[-80,5])&&(Ifelse(var(1),random<50,random<40)*(AIlevel ** 2 / 64.0))
...
;---------------------------------------------------------------------------------
[State -1, ki blast strong]
type = changestate
value = 1010
triggerall=AIlevel&&roundstate = 2 && statetype != A
triggerall=(enemynear,Movetype!=A)&&(enemynear,stateno!=[120,155])&&(enemynear,statetype!=A)&&(enemynear,statetype!=C)&&(enemynear,statetype!=L)
triggerall=(p2dist x>=100)&&(p2dist y=[-80,5])&&(Ifelse(var(1),random<50,random<40)*(AIlevel ** 2 / 64.0))
triggerall =!numhelper(1005)&&!numhelper(1025)&&!numhelper(1015) && !numhelper(3005) && !numhelper(3025) && !numhelper(3045) && !numhelper(3055)
trigger1 = ctrl
trigger2 = (stateno = [200,449])&&anim!=221&&stateno!=420&&movecontact
;-----------------------------------------------------------------------------------
[State -1, air ki blast]
type = changestate
value = 1050
triggerall=AILevel && roundstate=2 && statetype=A
triggerall=(enemynear,movetype!=A)&&(enemynear,statetype!=C)&&(enemynear,stateno!=[120,155])
triggerall =!numhelper(1005)&&!numhelper(1025)&&!numhelper(1015) && !numhelper(3005) && !numhelper(3025) && !numhelper(3045) && !numhelper(3055)
triggerall=(p2bodydist x=[20,50])&&(p2bodydist y=[-40,215])&&random < (400 * (AIlevel ** 2 / 64.0))&& Pos Y<=-20
trigger1 = ctrl
...
triggerall=(p2dist x=[15,70])&&(p2dist y=[-110,5])&&random<300*(AIlevel ** 2 / 64.0)
trigger1 = ctrl
...
triggerall=(enemynear,Movetype!=A)&&(enemynear,stateno!=[120,155])&&(enemynear,statetype!=A)&&(enemynear,statetype!=C)&&(enemynear,statetype!=L)
triggerall=(p2dist x>=80)&&(p2dist y=[-60,5])&&random<200*(AIlevel ** 2 / 64.0)
...
triggerall=AIlevel&&roundstate = 2 && statetype = A &&power >= 1000
triggerall=(enemynear,Movetype!=A)&&(enemynear,stateno!=[120,155])&&(enemynear,statetype!=C)&&(enemynear,statetype!=L)
triggerall=(p2dist x=[5,180])&&(p2dist y=[-100,-40])&&random<200*(AIlevel ** 2 / 64.0)
...
type = changestate
value = 4100
triggerall = AIlevel && roundstate = 2 && statetype != A && power >= 3000 && var(20) <= 60 && !inguarddist
