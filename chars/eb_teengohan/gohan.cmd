...
type = changestate
value = 3200
triggerall = !AIlevel&&command = "ssj2kamehameha"&&roundstate = 2 && statetype != A && power >= 3000
trigger1 = ctrl
trigger2 = (stateno = [200,419])&& movecontact
trigger3 = (stateno = [430,449])&& movecontact
;---------------------------------------------------------------------------
[State -1, masanko]
type = changestate
value = 3100
triggerall = !AIlevel&&command = "rushmasanko"&&roundstate = 2 && statetype != A && power >= 2000
trigger1 = ctrl
trigger2 = (stateno = [200,419])&& movecontact
trigger3 = (stateno = [430,449])&& movecontact
;---------------------------------------------------------------------------
...
type = changestate
value = 3050
triggerall = !AIlevel&&command = "masanko"&&roundstate = 2 && statetype = A && power >= 1000
trigger1 = ctrl
...
[State -1, Kohou]
type=ChangeState
value=1600;ifelse(command="Kohou_x",1100,ifelse(command="Kohou_y",1110,1120))
...
[State -1, Kohou]
type=ChangeState
value=1550;ifelse(command="Kohou_x",1100,ifelse(command="Kohou_y",1110,1120))
triggerall=!AILevel && RoundState=2 && StateType != A 
...
[State -1, Kohou]
type=ChangeState
value=1200;ifelse(command="Kohou_x",1100,ifelse(command="Kohou_y",1110,1120))
triggerall=!AILevel && RoundState=2 && StateType != A 
triggerall = command="kyaku"
trigger1 = ctrl
trigger2 = (stateno = [200,419])&& movecontact
...
[State -1, Kohou]
type=ChangeState
value=1100;ifelse(command="Kohou_x",1100,ifelse(command="Kohou_y",1110,1120))
triggerall=!AILevel && RoundState=2 && StateType != A 
triggerall = command="Kohou_x"|command="Kohou_y"|command="Kohou_z"
trigger1 = ctrl
trigger2 = (stateno = [200,419])&& movecontact
trigger3 = (stateno = [430,449])&& movecontact
;---------------------------------------------------------------------------
[State -1, Muraji Hadouken]
type = changestate
value = 1010
triggerall = !AIlevel&&roundstate = 2 && statetype != A
...
[State -1, ki blast]
type = changestate
value = 1000; ifelse(random < 500, 1050, 1000);1000
triggerall=AIlevel&&roundstate = 2 && statetype != A
...
triggerall=(p2dist x>=80)&&(p2dist y=[-80,5])&&(random<40*(AIlevel ** 2 / 64.0))
triggerall =!numhelper(1005)&&!numhelper(1025)&&!numhelper(1015) && !numhelper(3005) && !numhelper(3025) && !numhelper(3045) && !numhelper(3055)
trigger1 = ctrl
trigger2 = (stateno = [200,449])&&anim!=221&&stateno!=420&&movecontact
;---------------------------------------------------------------------------
...
triggerall=AIlevel&&roundstate = 2 && statetype != A
triggerall=(enemynear,Movetype!=A)&&(enemynear,stateno!=[120,155])&&(enemynear,statetype!=A)&&(enemynear,statetype!=C)&&(enemynear,statetype!=L)
triggerall=(p2dist x>=150)&&(p2dist y=[-80,5])&&(Ifelse(var(1),random<70,random<60)*(AIlevel ** 2 / 64.0))
triggerall =!numhelper(1005)&&!numhelper(1025)&&!numhelper(1015) && !numhelper(3005) && !numhelper(3025) && !numhelper(3045) && !numhelper(3055)
trigger1 = ctrl
trigger2 = (stateno = [200,449])&&anim!=221&&stateno!=420&&movecontact
;------------------------------------------------------------------------
...
triggerall=(p2dist x=[15,70])&&(p2dist y=[-110,5])&&(random<250)*(AIlevel ** 2 / 64.0)
trigger1 = ctrl
trigger2 = (stateno = [200,449])&&anim!=221&&stateno!=420&&movecontact
;---------------------------------------------------
...
type=changestate
value=1200
triggerall= AILevel && numenemy &&random < (250 * (AIlevel ** 2 / 64.0))
...
value = 1600
triggerall=AIlevel&&roundstate = 2 && statetype = A
triggerall=(enemynear,Movetype!=A)&&(enemynear,stateno!=[120,155])&&(enemynear,statetype=A)&&(enemynear,statetype!=L)
triggerall=(p2dist x=[10,70])&&(p2dist y=[-70,5])&&(random<250)*(AIlevel ** 2 / 64.0)
trigger1 = ctrl
trigger2 = (stateno = [600,619])&&movecontact
trigger3 = (stateno = [630,649])&&movecontact
;-----------------------------------------------------------------------------
[State -1, Hadou Sutonpu/Doragon Suipu]
type = changestate
value =1550
triggerall=AIlevel&&roundstate = 2 && statetype != A&&(enemynear,Movetype!=A)&&(enemynear,stateno!=[120,155])&&(enemynear,statetype!=A)
triggerall=(p2dist x<=65)&&(p2dist y=[-80,5])&&(random<100)*(AIlevel ** 2 / 64.0)
trigger1 = ctrl
...
triggerall = !numhelper(3005) && !numhelper(3025) && !numhelper(3045) && !numhelper(3055)&&!numhelper(3033)
trigger1 = ctrl
trigger2 = (stateno = [200,450])&&anim!=221&&stateno!=420&&movecontact
;--------------------------------------------------------------------------
...
type = changestate
value = 3050
triggerall=AIlevel&&roundstate = 2 && statetype = A &&power >= 1000&&(enemynear,Movetype!=A)&&(enemynear,stateno!=[120,155])&&var(1)
triggerall=(p2dist x=[5,90])&&(p2dist y=[-40,205])&&(random<250)*(AIlevel ** 2 / 64.0)&&Pos Y<=-40
trigger1 = ctrl
trigger2 = (stateno = [600,650])&&movecontact
;----------------------------------------------------------------------------------
[State -1, rush masanko]
type = changestate
value =3100
...
triggerall=(enemynear,Movetype!=A)&&(enemynear,stateno!=[120,155])&(enemynear,statetype!=C)&&(enemynear,statetype!=L)
triggerall=(p2dist x=[10,120])&&(p2dist y=[-110,5])&&random<400*(AIlevel ** 2 / 64.0)
trigger1 = ctrl
trigger2 = (stateno = [200,450])&&anim!=221&&stateno!=420&&movecontact