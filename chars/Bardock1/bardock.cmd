...
value = 1
;---------------------------------------------------------------------------
[State -1, Rebellion Trigger]
type = changestate
value = 3200
triggerall = !AIlevel&&command = "rebelliontrigger"&&roundstate = 2 && statetype != A && power >= 2000
trigger1 = ctrl
...
type = changestate
value = 3050
triggerall = !AIlevel&&command = "riotjavelin"&&roundstate = 2 && statetype = A && power >= 1000
...
trigger1 = ctrl
trigger2 = (stateno = [200,459])&&anim!=221&&stateno!=420&&movecontact
;-----------------------------------------------------------------------------------------
[State -1, Ki Blast]
type=ChangeState
value=1300
...
triggerall=(p2dist x=[0,90])&&(p2dist y=[-100,5])&&random<300*(AIlevel ** 2 / 64.0)
trigger1 = ctrl
...
triggerall=(p2dist x<=65)&&(p2dist y=[-80,5])&&random<80*(AIlevel ** 2 / 64.0)
trigger1 = ctrl
